...
def apply_ablation_overrides(a):
    ...
    a.use_spectral = True
    a.use_regime = True
    a.adaptive_alpha = True
    a.wass_reweight = True
    a.use_cqr_score = True

    if mode == "M1":        # w/o spectral
        a.use_spectral = False
        a.wass_reweight = False
    elif mode == "M2":      # w/o regime
        a.use_regime = False
    elif mode == "M3":      # w/o adaptive alpha
        a.adaptive_alpha = False
    elif mode == "M4":      # w/o Wasserstein score reweighting
        a.wass_reweight = False
    elif mode == "M5":      # w/o conditional residual-quantile calibration
        a.use_cqr_score = False


def run_ablation(args):
    """
    Run ACP ablations full; w/o spectral; w/o regime; w/o adaptive alpha;
    w/o Wasserstein score reweighting; w/o conditional residual-quantile calibration.
    """
